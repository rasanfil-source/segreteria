...
for (const file of ['gas_response_strategy.js', 'gas_prompt_context.js', 'gas_prompt_engine.js', 'gas_email_processor.js', 'gas_memory_service.js']) {
...
const api = vm.runInContext(`({ processor: Object.create(EmailProcessor.prototype),
  ...
  strategy: mapRelationalPostureToResponseStrategy_, context: createPromptContext })`, sandbox);
const cases = {
...
assert.equal(api.processor._normalizeRelationalPostureAlias_('unrecognised'), 'informational');
