...
2. Menu: ⏰ Trigger
3. Verifica presenza trigger "processEmailsMain"
...
**Fix:**
1. Esegui manualmente `processEmailsMain()` dall'editor
...
1. **Contatta supporto tecnico:** info@parrocchiasanteugenio.it
2. **Allega:**
